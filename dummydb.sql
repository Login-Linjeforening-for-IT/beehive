...
COPY public.audience (name, color, description) FROM stdin;
PUBLIC	79d1b4	These events are open to the public, and not restricted to students of members of Login.
STUDENTS	60cbe0	These events are open only to students of any college or university.
NTNU	565bf5	These events are restricted to students at NTNU.
LOGIN	e6702c	These events are restricted to members of Login
\.
...
COPY public.campus (name, postcode) FROM stdin;
Gjøvik	2815
Ålesund	6009
Dragvoll	7049
Gløshaugen	7034
...
COPY public.city (postcode, name) FROM stdin;
0001	OSLO
0010	OSLO
0015	OSLO
0018	OSLO
...
--
-- Data for Name: eventlocation; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: extlocation; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.extlocation (locationid, street, postcode) FROM stdin;
2	Strandgata 21	2821
\.
...
COPY public.location (locationid) FROM stdin;
1
2
\.
...
--
-- Data for Name: onpremlocation; Type: TABLE DATA; Schema: public; Owner: postgres
--
