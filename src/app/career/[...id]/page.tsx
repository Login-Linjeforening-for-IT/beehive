    ...
    return (
        <div className='page-container'>
            <div className='page-section--normal'>
                {jobad && (
                    <div className={`relative jobad-page jobad-page--${jobad.job.banner_image ? 'banner' : 'noBanner'}`}>
                        <div className='jobad-details'>
                            <div className='flex gap-[1rem] mb-[2rem] 450px:gap-[2rem] 800px:block'>
                                <div className='h-full w-[12rem] relative aspect-[3/2]'>
                                ...
                                <div className='jobad-details_company-name'>
                                    ...
                                    {jobad.organization.link_homepage ? (
                                        <a
                                            className='flex flex-row items-center jobad-details_company-name-link link--underscore-hover'
                                            // @ts-ignore
                            ...
                            <div className='grid grid-cols-[min-content_auto] gap-[1rem] mb-[3rem]'>
                                ...
                                <>
                                    <div className='flex-row items-center text-[var(--color-text-discreet)] inline-flex'>
