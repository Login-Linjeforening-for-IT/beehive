...
export default function FilterItem({filterData}:{filterData: any}) {
    ...
    return(
        <>
            ...
            <div
                className={`p-6 bg-[var(--color-bg-surface)] 1000px:bg-[var(--color-bg-body)]
                    my-2 rounded-[var(--border-radius)] shadow-[var(--container-shadow)]
                    ...
                    1000px:after:border-[var(--color-border-default)]
                    ...
                    1000px:before:border-[var(--color-border-default)]
