...
const DecoratedPicture = ({imgurl, variant, w, h, cornerSize}) => {
    ...
    return (
        <picture className='decor-pic'>
            <svg className={'decor-pic__svg decor-pic__svg--' + variant} viewBox={`0,0 ${w},${h}`} xmlns='http://www.w3.org/2000/svg'>
                <SVGcontent />
            </svg>
        </picture>
    )
