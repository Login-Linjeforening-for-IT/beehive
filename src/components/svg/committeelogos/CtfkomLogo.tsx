...
export default function CtfkomLogo() {
    return (
        <svg className='ctfkom-logo committee-logo' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'>
            ...
            <path className='ctfkom-logo_flag-piece-3 committee-logo--stroke-color committee-logo--fill-bg-color' d='m45 32.5 l25 0 l5 25 l-25 0 z' strokeWidth='3' />
            <path className='ctfkom-logo_flag-piece-2 committee-logo--stroke-color committee-logo--fill-bg-color' d='m25 27.5 l25 0 l5 25 l-25 0 z' strokeWidth='3' />                    
            <path className='ctfkom-logo_flag-piece-1 committee-logo--stroke-color committee-logo--fill-bg-color' d='m25 25 l0 0 l5 25 l0 0 z' strokeWidth='3' />
