...
export default function EventkomLogo() {
    return (
        <svg className='eventkom-logo committee-logo' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'>
            ...
            <path className='eventkom-logo_curve1 committee-logo--stroke-color' d='m45 75 A25 25 90 0 1 45 25' fill='none' strokeWidth='3' />
            <path className='eventkom-logo_curve2 committee-logo--stroke-color' d='m45 75 A25 13 90 0 1 45 25' fill='none' strokeWidth='3' />
            <path className='eventkom-logo_curve3 committee-logo--stroke-color' d='m45 25 A25 0 270 0 1 45 75' fill='none' strokeWidth='3' />
            <path className='eventkom-logo_curve4 committee-logo--stroke-color' d='m45 25 A25 13 270 0 1 45 75' fill='none' strokeWidth='3' />
            ...
            <path className='eventkom-logo_star1 committee-logo--stroke-color' d='M77.5 25 L79.7 32.125 L83 34.5 L79.7 36.875 L77.5 44 L75.3 36.875 L72 34.5 L75.3 32.125 L77.5 25 Z' fill='none' strokeWidth='2'/>
            <path className='eventkom-logo_star2 committee-logo--stroke-color' d='M68.5 70 L70.3 75.625 L73 77.5 L70.3 79.375 L68.5 85 L66.7 79.375 L64 77.5 L66.7 75.625 L68.5 70 Z' fill='none' strokeWidth='2'/>
        </svg>
    )
}
