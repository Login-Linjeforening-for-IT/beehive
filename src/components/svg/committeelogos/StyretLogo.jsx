    ...
    return (
      <svg className='styret-logo committee-logo' viewBox='0 0 100 100' fill='none' xmlns='http://www.w3.org/2000/svg'>            
        ...
        <g className='styret-logo__handlebars'>
          ...
          <path d='M57 65 H58 C60 65 62 63.7 62.7 61.7 L69.6 43.3 C70 41.3 72 40 74.2 40 H77' className='committee-logo--stroke-color' strokeWidth='4'/>
          <line x1='32' y1='46.5' x2='68' y2='46.5' className='committee-logo--stroke-color' strokeWidth='3'/>
          <line x1='78.5' y1='47.5' x2='78.5' y2='32.5' className='committee-logo--stroke-color' strokeWidth='3'/>
          <line x1='21.5' y1='47' x2='21.5' y2='32' className='committee-logo--stroke-color' strokeWidth='3'/>
          <rect x='9.5' y='36.5' width='12' height='6' className='committee-logo--stroke-color' strokeWidth='3'/>
          <rect x='78.5' y='37' width='12' height='6' className='committee-logo--stroke-color' strokeWidth='3'/>
        </g>
      </svg>
    )
}
