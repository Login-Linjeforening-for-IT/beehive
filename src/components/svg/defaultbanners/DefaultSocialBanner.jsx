...
const DefaultSocialBanner = ({ color }) => {
    ...
    return (
        <div className='default-banner' style={{background: gradient}}>
            <svg className='default-banner__svg' viewBox="0 0 500 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fillRule="evenodd" clipRule="evenodd" d="M240.25 137.5V62.5H244.75V137.5H240.25Z" fill={fillColor}/>
                <path fillRule="evenodd" clipRule="evenodd" d="M254.292 74.5215C250.796 67.7979 246.434 64.75 242.5 64.75V60.25C248.909 60.25 254.467 65.1038 258.285 72.4455C262.146 79.8701 264.25 89.7831 264.25 100C264.25 110.217 262.146 120.13 258.285 127.555C254.467 134.896 248.909 139.75 242.5 139.75V135.25C246.434 135.25 250.796 132.202 254.292 125.478C257.745 118.838 259.75 109.674 259.75 100C259.75 90.3257 257.745 81.1622 254.292 74.5215Z" fill={fillColor}/>
                <path fillRule="evenodd" clipRule="evenodd" d="M280 102.25H205V97.75H280V102.25Z" fill={fillColor}/>
                <path fillRule="evenodd" clipRule="evenodd" d="M277 85.75H208V81.25H277V85.75Z" fill={fillColor}/>
                <path fillRule="evenodd" clipRule="evenodd" d="M277 118.75H208V114.25H277V118.75Z" fill={fillColor}/>
                <path fillRule="evenodd" clipRule="evenodd" d="M291.25 57.416L295.835 72.2643L302.068 76.7503L295.835 81.2362L291.25 96.0846L286.665 81.2363L280.432 76.7503L286.665 72.2643L291.25 57.416ZM291.25 67.5846L289.235 74.1112L285.568 76.7503L289.235 79.3893L291.25 85.916L293.265 79.3893L296.932 76.7503L293.265 74.1112L291.25 67.5846Z" fill={fillColor}/>
                <path fillRule="evenodd" clipRule="evenodd" d="M277.75 125.079L281.724 137.496L287.13 141.25L281.724 145.005L277.75 157.422L273.776 145.005L268.37 141.25L273.776 137.496L277.75 125.079ZM277.75 134.922L276.324 139.38L273.63 141.25L276.324 143.121L277.75 147.579L279.176 143.121L281.87 141.25L279.176 139.38L277.75 134.922Z" fill={fillColor}/>
            </svg>
        </div>
    )
}
