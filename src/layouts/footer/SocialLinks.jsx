...
const SocialLinks = () => {
  return (
    <div className='social-links' target='_blank' rel='noreferrer'>
      ...
      <a className='social-links__link'title='Redmine' href='https://redmine.logntnu.no/' target='_blank' rel='noreferrer'>
        <i className='social-links__icon social-links__icon--redmine logfont-redmine'></i>
      </a>
    </div>
  );
}
