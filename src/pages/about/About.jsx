  ...
  return (
    <div className='page-container'>
      ...
      <section className='page-section--normal about-section about-intro'>
        <p className='about-intro__p p--highlighted' dangerouslySetInnerHTML={{__html: t('intro')}}/>
        <div className='about-intro__grid-container'>
          <StudyProgramsAcordion/>
          <DecoratedPicture imgurl={config.url.CDN_URL + '/img/styret2.jpg'} variant={3} cornerSize={400} w={1420} h={947} />
        </div>
      </section>
      <section className='page-section--normal about-section'>
        <h2 className='heading-2'>{t('about.title')}</h2>
        <div className='p--columes'>
          <p className='p--highlighted' dangerouslySetInnerHTML={{__html: t('about.intro')}}/>
          <p className='p--regular' dangerouslySetInnerHTML={{__html: t('about.body.p1')}}/>
          <p className='p--regular' dangerouslySetInnerHTML={{__html: t('about.body.p2')}}/>
        </div>
      </section>
      ...
      <section className='page-section--normal about-section about-public-docs'>
        ...
        <p className='p--regular' dangerouslySetInnerHTML={{__html: t('publicDocs.body')}}/>
