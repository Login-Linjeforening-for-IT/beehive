...
const EventPage = ({ t, i18n }) => {
  ...
  if (loading) return <Spinner w="50" h="50" />;

  if (!event) return <div className="event-page">Could not retrive event, id: {id}</div>;
  ...
  return (
    <div className="event-page">
      ...
      <div className="event-banner">{eventBanner}</div>
